...
const Header = () => {
  ...
  return (
    <header className="w-full bg-white border-b border-[#E8ECF0]">
      <nav className="flex justify-between items-center w-full px-4 sm:px-6 md:px-12 py-4">
        <div className="flex items-center gap-4 md:gap-8 lg:gap-12">
          <Link to="/" className="flex items-center gap-2 md:gap-3 flex-shrink-0">
            ...
            <span className="text-base md:text-lg lg:text-xl font-semibold text-[#1A1D23] hidden sm:inline">
          ...
          <div className="hidden lg:flex items-center gap-6 xl:gap-8">
            <Link
              to="/"
              className={`flex items-center gap-2 transition text-sm xl:text-base ${
        ...
        <div className="flex items-center gap-2 md:gap-3 lg:gap-6">
          ...
          <button className="hidden lg:flex items-center gap-2 bg-[#1B3A5F] text-white/95 px-4 lg:px-6 py-2 lg:py-3 rounded-lg hover:bg-[#2D5280] transition flex-shrink-0">
            <span className="whitespace-nowrap text-xs lg:text-base font-semibold">{t.hero.cta1}</span>
          </button>

          <button
            onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
            className="lg:hidden flex items-center justify-center w-10 h-10 text-[#1A1D23]"
          >
            <iconify-icon
      ...
      {/* Mobile/Tablet Menu */}
      {mobileMenuOpen && (
        <div className="lg:hidden border-t border-[#E8ECF0] bg-white">
          <div className="flex flex-col px-4 py-4 gap-4">
            ...
            <button className="flex items-center justify-center gap-2 bg-[#1B3A5F] text-white/95 px-6 py-3 rounded-lg hover:bg-[#2D5280] transition mt-2 w-full">
